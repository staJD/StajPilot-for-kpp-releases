...
> 박혀있는 색상 LED(뱅크 식별용)를 함께 사용합니다. 이 둘은 완전히
> 동일하거나 거의 동시에 이동해야 합니다. 보다 동기화 되게 개발하는 것이
...
> (used for bank identification). These two are meant to move
> completely identically, or nearly simultaneously — keeping that sync
> as tight as possible is a core StajPilot development goal. If a
...
> data fast enough. Kemper themselves recommend avoiding polling during
