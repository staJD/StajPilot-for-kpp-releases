...
추가 모듈이 따로 필요 없습니다. 보드 자체 가격도 **$30** 정도예요.
...
연결하세요 (초기 비밀번호는 `12345678`이며, 웹 설정 페이지에서 바꿀 수
있습니다). 그다음 웹 브라우저에서 `192.168.4.1`을 여세요 - 곡을 한번에 많이
...
한국은 전안법, 전파법이 있습니다. 개인용으로만 사용하시고, 1년 내 기기 자체도
판매하시면 안 됩니다. 이 일로 인하여 괜히 형사에 휘말리는 불상사가 없었으면 합니다.

그리고 1년 이상 경과 후에 기기를 판매하실 때는 기기는 반드시 라이센스 해제해서
양도하시기 바랍니다 (라이센스 해제 펌웨어는 1년 내 업데이트하겠습니다). 제
소프트웨어가 깔린 채로 판매되는 걸 원치 않습니다. 구매자분이 다시 여기서 처음부터
절차를 밟아 설치해서 사용하시는 건 무방합니다. 기기 양도 시 제 소프트웨어의 양도는
허용하지 않습니다.
