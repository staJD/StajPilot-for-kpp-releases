...
그리고 1년 후에 기기를 판매하실 때는 기기를 반드시 초기화해서 양도하시기 바랍니다
(초기화 펌웨어는 1년 내 업데이트하겠습니다). 제 소프트웨어가 깔린 채로 판매되는 걸
원치 않습니다. 구매자분이 다시 여기서 처음부터 절차를 밟아 설치해서 사용하시는 건
무방합니다. 기기 양도 시 제 소프트웨어의 양도는 허용하지 않습니다.
