...
> shows up, it can be a sign the Kemper is already under heavy load, or
> a sign of a bottleneck where the connected device can't keep up
> processing the signal. This usually happens when too many requests
> are being sent to the Kemper,
